        ...
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">341 Hung Vuong ward 9 District 5</p>
              <p className="office__info">Phone: +84 938922810</p>

              <p className="office__info">Email: locdinh.31221020226@st.ueh.edu.vn</p>
